...
const submitForm = async () => {
    ...
    try {
        const response = await axios.post('http://localhost:3000/tutors', formData, {
            headers: {
        ...
        submitError.value = error.response?.data?.message || 'An error occurred while submitting the application. Please try again.';
    } finally {
